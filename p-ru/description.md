...
Выбор стартовой площадки, у которой необходимо запросить новое задание на выполнение, осуществляется 
...
будет создан файл system-console.log в котором будет выведно содержимое файла,
